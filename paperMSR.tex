...
After anlayzed all the previous commit involved in the 209 Bug reports, we have discovered that not all the previous commits were responsibles to cause the bug.
