...
This analysis takes into account that the bug could have been inserted in several lines in several commits, but not everyone had to be responsible for the commit; sometimes the previous commit copied lines from its previous commit or inserted comments and blank spaces. In fact, the cause could be found in a single commit, in many or even in none. FIXME: repasar este parrafo
...
As can be seen in Table~\ref{tab:responsability}, in 152 cases the previous commits have been considered the cause of the bug, whereas 114 times they were not the cause. We were unable to identify the cause of the bug in 42 cases, and discarded 40 more because they were noise. FIXME: explicar que es eso de noise!
