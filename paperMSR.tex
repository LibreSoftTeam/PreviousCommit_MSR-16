...
The information about the bug fix commit is shown in the figure \ref{fig:6}, this information has been extracted from the gerrit of the figure \ref{fig:1} and we can apreciate that the previous commit in the example \ref{fig:1}(\textit{31f08423}) is different from the parent commit displayed in the figure \ref{fig:6},(\textit{db7fc59ebc}).
\begin{figure}[ht]
\centering
\includegraphics[height=2cm]{parent.png}
\label{fig:6}       % Give a unique label
\caption{Information about the bug fix commit displayed in gerrit. }
\end{figure}
...
\bottomrule[0.3mm]
\end{tabular} }
\caption{ Distribution of the number of previous commits per bug report for each project.}
