...
%\begin{figure}[ht]
%\centering
%\includegraphics[height=12cm]{manylines.png}
%\caption{Screenshot of the tool used to classify the tickets.}
%\label{fig:screenshot}       % Give a unique label
%\end{figure}
...
\grex{Entiendo el resultado del parrafo anterior, pero me falta una explicacion de por que esto es interesante y para que puede servir.}\gema{Para tener una idea de como se distribuyen los causantes del error, podría eliminar las tablas si en realidad no las encuentras funcionales y no aportan informacion. }
...
\gema{Puedes elaborar un poco mas el parrafo anterior? Puede ser en castellano}
