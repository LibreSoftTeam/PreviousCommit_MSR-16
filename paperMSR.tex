...
Figure~\ref{fig:parent} contains a snapshot of the information provided by Gerrit, where the link to the parent commit(s) can be found.
...
\caption{Information about the bug offered by Gerrit.}
\end{figure}
