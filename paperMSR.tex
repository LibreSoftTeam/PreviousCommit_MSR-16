...
\begin{itemize}
  ...
  \item The changes to the source code, as sometimes neither the descriptions nor the comments by developers in the Launchpad and Gerrit of each ticket, clarified the underlying ticket. FIXME: what comments?
\end{itemize}
...
This analysis takes into account that the bug could have been inserted in many lines belong to many differnt previous commits, but in fact, not all of them could cause the bug. Could happen that these previous commit copied lines from its previous commits or modified the comments and added blank spaces. Thus, the cause could be found in a single previous commit, in many or even in none. FIXME: repasar este parrafo
...
FIXME: explicar que es eso de noise!, Con Noise me referia a los falsos positivos que puede haber en los commits previos, las líneas copiadas de otros commits o lineas en blanco, comentarios ...
...
\end{center}
\end{table}
[Los resultados que he obtenido y que queria plasmar en las tablas son:
...
\begin{enumerate}
 \item No todos los casos son tan claros como los mostrados en los ejemplos, hay ocasiones en las que solo se han anadido codigo 
