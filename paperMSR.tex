...
The empirical experiment carried out in OpenStack, supported that the current premisse assumed does not hold for a large fraction of the analyzed bugs, because around the half of the previous commits were not responsibles inserting the bug.
