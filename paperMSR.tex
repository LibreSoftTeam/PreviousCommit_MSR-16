...
In this stage we analyzed the 209 tickets classified as bug reports and their previous commits.
...
We identified a total of 348 previous commits which could be the cause of the 292 bugs under analysis, and analyzed the bug reports together with their previous commits.
...
If we attend to how many previous commits each of the 292 bug reports analyzed had, we see that 131 only had a previous commit, whereas 58 had more than one previous commit. As can be seen from Table~\ref{tab:secondStage}, from the 131 unique previous commits, 65 were the cause of the bug, and 30 not the cause. For the 58 bugs that had more than one previous commit, a total number of 189 previous commits were identified; of them 86 were the cause of the bug, while 82 were not.
...
\raisebox{1ex}{Cause}     & 65 & 86 \\[0ex]
\raisebox{1ex}{Not cause} & 30 & 82 \\[0ex]
\raisebox{1ex}{Undecided} & 36 & 11 \\[0ex]
\bottomrule[0.3mm]
\end{tabular} }
\caption{Probability of the cause of the bug depending on how many previous commits the bug report had.}
