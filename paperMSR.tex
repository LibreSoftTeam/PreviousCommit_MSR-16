...
\begin{itemize}
    %\item RQ1 : How can tickets which are bug reports be differentiated from those that are not?
     ...
     \item RQ1: How we can identify a change done to fix a bug inserted in the code source? \gema{Que tal esta forma de plantear la RQ1? Esta pregunta se refiere a como podemos diferenciar los bug reports de los otros pero realizada desde el punto de vista del comit previo }
