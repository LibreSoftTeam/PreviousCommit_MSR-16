...
As can be seen in Table~\ref{tab:responsability}, in 152 cases the previous commits have been considered the cause of the bug, whereas 114 times they were not the cause. We were unable to identify the cause of the bug in 42 cases, and discarded 40 more because they ere false positives such as blank lines, changes in comments or even a change in the version of the file. FIXME: explicar que es eso de noise!, Con Noise me referia a los falsos positivos que puede haber en los commits previos, las líneas copiadas de otros commits o lineas en blanco, comentarios ...
